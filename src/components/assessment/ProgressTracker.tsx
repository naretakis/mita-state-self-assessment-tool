            ...
            <div className="ds-u-text-align--right ds-u-text-align--left--md">
              {saving ? (
                <div className="ds-u-display--flex ds-u-align-items--center ds-u-justify-content--end ds-u-justify-content--start--md">
                  <div className="ds-c-spinner ds-c-spinner--small ds-u-margin-right--1" />
                  <span className="ds-text--small ds-u-color--muted">Saving...</span>
                </div>
              ) : lastSaved ? (
                <div className="ds-u-display--flex ds-u-align-items--center ds-u-justify-content--end ds-u-justify-content--start--md">
                  <svg
                  ...
                  <span className="ds-text--small ds-u-color--success">
