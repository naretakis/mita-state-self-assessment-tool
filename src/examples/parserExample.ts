...
async function runParserExample() {
  ...
  try {
    ...
    console.log(`  Level 1: ${capability.dimensions.outcome.maturityLevels.level1.substring(0, 50)}...`);
    console.log(`  Level 5: ${capability.dimensions.outcome.maturityLevels.level5.substring(0, 50)}...`);
